...
| **Category** | **Badge** |
|-----------------------|-----------|
| **Documentation** | [![Stable Docs](https://img.shields.io/badge/docs-stable-blue.svg)](https://control-toolbox.org/LossControl.jl/stable/) [![Dev Docs](https://img.shields.io/badge/docs-dev-8A2BE2.svg)](https://control-toolbox.org/LossControl.jl/dev/) |
...
| **Test Coverage** | [![Coverage](https://codecov.io/gh/control-toolbox/LossControl.jl/branch/main/graph/badge.svg)](https://codecov.io/gh/control-toolbox/LossControl.jl) |
| **Release / Version** | [![Release](https://juliahub.com/docs/General/LossControl/stable/version.svg)](https://github.com/control-toolbox/LossControl.jl/releases) |
